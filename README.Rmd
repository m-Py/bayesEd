...
$r$. The default scaling parameter is $\frac{\sqrt{2}}{2} \approx 0.71$,
which is the also the default setting in the package `BayesFactor`.  The
following plot illustrates the scaling parameter:
...
scaling parameter $\frac{\sqrt{2}}{2}$. The following call illustrates
the predictions of the Cauchy prior and the null hypothesis for a sample
size of 100:
